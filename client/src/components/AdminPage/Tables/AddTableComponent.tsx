...
export default function AddTableComponent({
  ...
  return (
    ...
    >
      <TextField
        style={{ marginRight: "0.5rem", background: "white" }}
        type="number"
      ...
      <Button
        ...
        variant="contained"
        disabled={number === 0}
        onClick={() => onCreateTables(number)}
      >
        Crear {number} {number >= 2 ? "mesas" : "mesa"}
      </Button>
      <Button variant="contained" color="error" onClick={onDeleteTables}>
